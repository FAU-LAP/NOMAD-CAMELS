...
def change_devices(device_dict:dict, ioc='CAMELS'):
    ...
    for key in sorted(device_dict):
        ...
        asyn_port_string, load_record_string = update_addresses(key, addresses,
                                                                device.settings,
                                                                asyn_port_string,
                                                                load_record_string,
                                                                ioc)
