...
# Keysight E5270B -  Precision IV Analyzer (SMU)

## Install
Install the instrument using the _Manage Instruments_ button of NOMAD-CAMELS.\
The PyPi package can be found [here](https://test.pypi.org/project/nomad-camels-driver-keysight-e5270b/) and can be installed via 
