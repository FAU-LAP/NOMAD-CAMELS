...
# Keysight B2912A - Source Measure Unit (SMU)

## Install
Install the instrument using the _Manage Instruments_ button of NOMAD-CAMELS.\
The PyPi package can be found [here](https://test.pypi.org/project/nomad-camels-driver-keysight-b2912a/) and can be installed via 
