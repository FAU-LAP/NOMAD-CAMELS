...
from nomad-camels.bluesky_handling.custom_function_signal import Custom_Function_Signal, Custom_Function_SignalRO
...
class PID_Controller(Device):
    ...
    def __init__(self, prefix='', *, name, kind=None, read_attrs=None,
        ...
        if name != 'test':
            ...
            # if show_plot:
            from nomad-camels.main_classes.plot_widget import PlotWidget_NoBluesky
            y_axes = {'output': 2,
                      'k': 2,
                      'i': 2,
                      'd': 2}
