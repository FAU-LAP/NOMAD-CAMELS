...
from nomad-camels.gui.mainWindow_v2 import Ui_MainWindow
from nomad-camels.utility import exception_hook

from pkg_resources import resource_filename

from nomad-camels.frontpanels.helper_panels.button_move_scroll_area import Drop_Scroll_Area
from nomad-camels.utility import load_save_functions, variables_handling, number_formatting, theme_changing
from nomad-camels.ui_widgets import options_run_button
...
class MainWindow(Ui_MainWindow, QMainWindow):
    ...
    def manage_instruments(self):
        ...
        from nomad-camels.frontpanels.manage_instruments import ManageInstruments
    ...
    def edit_user_info(self):
        ...
        """
        import pandas as pd
        from nomad-camels.ui_widgets import add_remove_table
    ...
    def change_catalog_name(self):
        if 'meas_files_path' in self.preferences:
            ...
            from nomad-camels.bluesky_handling import make_catalog
    ...
    def change_preferences(self):
        ...
        from nomad-camels.frontpanels.settings_window import Settings_Window
    ...
    def add_manual_control(self):
        from nomad-camels.manual_controls.get_manual_controls import New_Manual_Control_Dialog
    ...
    def open_manual_control_config(self, control_name):
        from nomad-camels.manual_controls.get_manual_controls import get_control_by_type_name
    ...
    def add_measurement_protocol(self):
        from nomad-camels.frontpanels.protocol_config import Protocol_Config
    ...
    def run_protocol(self, protocol_name):
        from nomad-camels.utility import device_handling
    ...
    def protocol_finished(self, *args):
        from nomad-camels.utility import databroker_export, device_handling
    ...
    def build_protocol(self, protocol_name, ask_file=True):
        """Calls the build_protocol from nomad-camels.bluesky_handling.protocol_builder
        ...
        from nomad-camels.bluesky_handling import protocol_builder
    ...
    def launch_device_builder(self):
        from nomad-camels.tools import VISA_device_builder
