from nomad-camels.main_classes.loop_step import Loop_Step
from nomad-camels.loop_steps import for_while_loops, read_channels, set_channels,\
...
step_type_config = {'Change Device Config': [change_device_config.Change_DeviceConf,
                    ...
                    'Set Value Popup': [set_value_popup.Set_Value_Popup,
