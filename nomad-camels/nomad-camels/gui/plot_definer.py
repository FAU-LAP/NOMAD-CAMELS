...
from nomad-camels.ui_widgets.variable_tool_tip_box import Variable_Box
...
class Ui_Plot_Definer(object):
    def setupUi(self, Plot_Definer):
        ...
        self.checkBox_plot = QCheckBox(Plot_Definer)
        self.checkBox_plot.setObjectName(u"checkBox_plot")
        ...
        self.gridLayout_2.addItem(self.verticalSpacer, 6, 0, 1, 4)
