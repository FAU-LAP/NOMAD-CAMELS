...
from nomad-camels.ui_widgets.path_button_edit import Path_Button_Edit
...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        settings_window.resize(549, 485)
        ...
        self.gridLayout.addWidget(self.comboBox_theme, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_11, 24, 1, 1, 3)

        self.label_13 = QLabel(settings_window)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setFont(font1)

        self.gridLayout.addWidget(self.label_13, 19, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.comboBox_material_theme, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_dark, 4, 3, 1, 1)
