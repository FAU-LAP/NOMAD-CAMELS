...
# from nomad-camels.main_classes.protocol_class import Measurement_Protocol
from nomad-camels.utility import variables_handling, device_handling, load_save_functions

from nomad-camels.bluesky_handling.builder_helper_functions import plot_creator
...
standard_string += 'from nomad-camels.main_classes import plot_widget, list_plot, plot_2D\n'
standard_string += 'from nomad-camels.utility.databroker_export import broker_to_hdf5, broker_to_dict, broker_to_NX\n'
standard_string += 'from nomad-camels.utility import theme_changing\n'
standard_string += 'from nomad-camels.bluesky_handling.evaluation_helper import Evaluator\n'
standard_string += 'from nomad-camels.bluesky_handling import helper_functions\n'
...
def build_protocol(protocol, file_path,
    ...
    for dev in protocol.get_used_devices():
        ...
        device_import_string += f'from nomad-camels_driver_{device.name}.{device.name}_ophyd import {classname}\n'
    ...
    protocol_string += '\tfrom nomad-camels.utility import tqdm_progress_bar\n'
