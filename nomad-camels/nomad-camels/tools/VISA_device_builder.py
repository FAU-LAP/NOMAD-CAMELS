...
from nomad-camels.utility import variables_handling, fit_variable_renaming
from nomad-camels.tools.VISA_builder import Ui_VISA_Device_Builder
...
class VISA_Device_Builder(QDialog, Ui_VISA_Device_Builder):
    ...
    def build_device(self):
        ...
        class_string += 'from nomad-camels.main_classes import device_class\n\n'
        ...
        ophyd_string += 'from nomad-camels.bluesky_handling.visa_signal import VISA_Signal_Write, VISA_Signal_Read, VISA_Device\n\n'
