...
class VISA_Device_Builder(QDialog, Ui_VISA_Device_Builder):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('NOMAD-CAMELS - VISA-device-builder')
    ...
    def build_device(self):
        ...
        ophyd_string += 'from nomad_camels.bluesky_handling.visa_signal import VISA_Signal_Write, VISA_Signal_Read, VISA_Device\n\n'
