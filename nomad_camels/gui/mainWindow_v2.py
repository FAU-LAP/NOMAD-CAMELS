...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionWatchdogs.setObjectName("actionWatchdogs")
        ...
        self.queue_variable_table.setObjectName("queue_variable_table")
        ...
        self.textEdit_meas_description.setObjectName("textEdit_meas_description")
        ...
        self.run_queue_widget.setObjectName("run_queue_widget")
        ...
        sizePolicy.setHeightForWidth(
            self.comboBox_sample.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.pushButton_editSampleInfo.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.pushButton_nomad_sample.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave_Preset.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Save your current instrument configuration and protocols\n"
                "(CAMELS automatically saves on closing the program)",
                None,
            )
        )
        ...
        # if QT_CONFIG(tooltip)
        self.actionLoad_Backup_Preset.setToolTip(
            QCoreApplication.translate("MainWindow", "Load another preset", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.actionNew_Preset.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Create a new Preset, i.e. an empty version of CAMELS with no configured instruments or protocols",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.actionWatchdogs.setText(
            QCoreApplication.translate("MainWindow", "Watchdogs", None)
        )
        # if QT_CONFIG(tooltip)
        self.pushButton_resume.setToolTip(
            QCoreApplication.translate("MainWindow", "resume the paused protocol", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.textEdit_console_output.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "These are messages from the running CAMELS, mostly useful for debugging",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.textEdit_console_output.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "Log is currently empty.", None)
        )
        # if QT_CONFIG(tooltip)
        self.pushButton_close_plots.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "close all open plots\n"
                "plots from a running protocol reopen with new data",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.pushButton_stop.setToolTip(
            QCoreApplication.translate("MainWindow", "abort the running protocol", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_clear_log.setToolTip(
            QCoreApplication.translate("MainWindow", "clear the log window", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_pause.setToolTip(
            QCoreApplication.translate("MainWindow", "pause the running protocol", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_show_log.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "open / close the log with advanced system messages", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_show_log.setText(
            QCoreApplication.translate("MainWindow", "Show Log", None)
        )
        self.textEdit_meas_description.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindow", "Add a measurement description here.", None
            )
        )
        self.label.setText(
            QCoreApplication.translate("MainWindow", "Measurement Description", None)
        )
        # if QT_CONFIG(tooltip)
        self.run_queue_widget.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Add a new protocol to the queue or customize queued protocols, e.g. modify variables ",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.progressBar_protocols.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Calculated from the number of steps in the protocol.\n"
                "Protocols with While Loops or If statements may have bad calculations!",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.label_remaining_time.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "elapsed time of the protocol run /\nestimated time to finish",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_remaining_time.setText(
            QCoreApplication.translate("MainWindow", "00:00 / 00:00", None)
        )
        self.label_logo.setText("")
        # if QT_CONFIG(tooltip)
        self.pushButton_manage_instr.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "Configure your instruments or install new drivers", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.comboBox_sample.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "Select the sample you are currently measuring.", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.pushButton_editSampleInfo.setToolTip(
            QCoreApplication.translate("MainWindow", "Add or modify samples. ", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.checkBox_use_nomad_sample.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "only when this box is checked, the sample from NOMAD is used for the data",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_nomad_sample.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "Choose a sample from your NOMAD entries", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.label_4.setToolTip(
            QCoreApplication.translate(
                ...
                "Used to distinguish different measurements",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.lineEdit_session.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "- Optional -\n"
                "Adds a sub-folder for the saved data with the name of the session\n"
        ...
        # endif // QT_CONFIG(tooltip)
        self.lineEdit_session.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "Add optional Session name", None)
        )
        # if QT_CONFIG(tooltip)
        self.label_6.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Press Enter to add Tags. Remove Tags by pressing the red x on the tag.",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_6.setText(QCoreApplication.translate("MainWindow", "Tags", None))
        # if QT_CONFIG(tooltip)
        self.lineEdit_tags.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Press Enter to add Tags. Remove Tags by pressing the black x on the tag. \n"
                "Useful to identify / filter measurements",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lineEdit_tags.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "Press Enter to add Tag", None)
        )
        # if QT_CONFIG(tooltip)
        self.scrollArea.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "Currently used Tags. Remove by pressing the black x",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.comboBox_user.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "Select the user that is currently measuring.", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.pushButton_editUserInfo.setToolTip(
            QCoreApplication.translate("MainWindow", "Add or modify users. ", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_add_manual.setToolTip(
            QCoreApplication.translate("MainWindow", "add a new manual control", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_add_meas.setToolTip(
            QCoreApplication.translate("MainWindow", "create a new protocol", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.pushButton_import_protocol.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "Import a previously run / exported protocol", None
            )
        )
        # endif // QT_CONFIG(tooltip)
