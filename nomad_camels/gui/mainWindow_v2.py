...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.comboBox_sample, 0, 11, 1, 1)

        self.lineEdit_session = QLineEdit(self.widget)
        self.lineEdit_session.setObjectName(u"lineEdit_session")

        self.gridLayout_6.addWidget(self.lineEdit_session, 0, 15, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_4, 0, 14, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.pushButton_editSampleInfo, 0, 12, 1, 1)
