...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        settings_window.resize(391, 679)
        ...
        self.line_7 = QFrame(settings_window)
        self.line_7.setObjectName(u"line_7")
        self.line_7.setFrameShadow(QFrame.Raised)
        self.line_7.setLineWidth(5)
        self.line_7.setFrameShape(QFrame.HLine)

        self.gridLayout.addWidget(self.line_7, 31, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.buttonBox, 37, 1, 1, 3)
        ...
        self.label_19 = QLabel(settings_window)
        self.label_19.setObjectName(u"label_19")

        self.gridLayout.addWidget(self.label_19, 33, 1, 1, 1)
        ...
        self.lineEdit_oasis = QLineEdit(settings_window)
        self.lineEdit_oasis.setObjectName(u"lineEdit_oasis")

        self.gridLayout.addWidget(self.lineEdit_oasis, 33, 2, 1, 2)
        ...
        self.label_18 = QLabel(settings_window)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setFont(font)

        self.gridLayout.addWidget(self.label_18, 32, 1, 1, 1)

        self.line_8 = QFrame(settings_window)
        self.line_8.setObjectName(u"line_8")
        self.line_8.setFrameShadow(QFrame.Raised)
        self.line_8.setLineWidth(5)
        self.line_8.setFrameShape(QFrame.HLine)

        self.gridLayout.addWidget(self.line_8, 34, 1, 1, 3)

        self.label_20 = QLabel(settings_window)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setFont(font)

        self.gridLayout.addWidget(self.label_20, 35, 1, 1, 1)

        self.label_21 = QLabel(settings_window)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setMaximumSize(QSize(16777215, 17))

        self.gridLayout.addWidget(self.label_21, 36, 1, 1, 1)

        self.pathButton_extension_path = Path_Button_Edit(settings_window)
        self.pathButton_extension_path.setObjectName(u"pathButton_extension_path")

        self.gridLayout.addWidget(self.pathButton_extension_path, 36, 2, 1, 2)
    ...
    def retranslateUi(self, settings_window):
        ...
        self.label_20.setText(QCoreApplication.translate("settings_window", u"Extensions", None))
