...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        self.lineEdit_oasis.setObjectName("lineEdit_oasis")
        ...
        self.spinBox_n_databroker_files.setObjectName("spinBox_n_databroker_files")
        ...
        self.pathButton_extension_path.setObjectName("pathButton_extension_path")
        ...
        self.checkBox_auto_check_updates.setObjectName("checkBox_auto_check_updates")
        ...
        self.spinBox_logfile_size.setObjectName("spinBox_logfile_size")
        ...
        self.spinBox_logfile_number.setObjectName("spinBox_logfile_number")
        ...
        self.radioButton_smart_backups.setObjectName("radioButton_smart_backups")
        ...
        self.checkBox_autosave_run.setObjectName("checkBox_autosave_run")

        self.gridLayout_2.addWidget(self.checkBox_autosave_run, 2, 2, 1, 1)

        self.checkBox_backup_before_run = QCheckBox(self.saving)
        self.checkBox_backup_before_run.setObjectName("checkBox_backup_before_run")
        ...
        self.checkBox_new_file_each_run.setObjectName("checkBox_new_file_each_run")
        ...
        self.number_format.setObjectName("number_format")
        ...
        self.comboBox_material_theme.setObjectName("comboBox_material_theme")
    ...
    def retranslateUi(self, settings_window):
        settings_window.setWindowTitle(
            QCoreApplication.translate("settings_window", "Dialog", None)
        )
        self.label_12.setText(
            QCoreApplication.translate("settings_window", "Driver Repository URL", None)
        )
        self.label_8.setText(
            QCoreApplication.translate("settings_window", "Local drivers path", None)
        )
        self.lineEdit_branch.setPlaceholderText(
            QCoreApplication.translate("settings_window", "branch", None)
        )
        self.label_13.setText(
            QCoreApplication.translate("settings_window", "Drivers", None)
        )
        self.lineEdit_directory.setPlaceholderText(
            QCoreApplication.translate("settings_window", "directory", None)
        )
        self.label_14.setText(
            QCoreApplication.translate("settings_window", "Branch / Directory", None)
        )
        self.label_19.setText(
            QCoreApplication.translate("settings_window", "NOMAD Oasis URL", None)
        )
        self.label_18.setText(
            QCoreApplication.translate("settings_window", "ELN integration", None)
        )
        self.label_7.setText(
            QCoreApplication.translate("settings_window", "Measurement-Data Path", None)
        )
        self.label_6.setText(
            QCoreApplication.translate("settings_window", "Python-Files Path", None)
        )
        self.label_10.setText(
            QCoreApplication.translate(
                "settings_window", "Databroker catalog-name", None
            )
        )
        self.label_5.setText(
            QCoreApplication.translate("settings_window", "Files", None)
        )
        self.label_20.setText(
            QCoreApplication.translate("settings_window", "# databroker files", None)
        )
        # if QT_CONFIG(tooltip)
        self.spinBox_n_databroker_files.setToolTip(
            QCoreApplication.translate(
                "settings_window", 'with "0" all files will be kept', None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_21.setText(
            QCoreApplication.translate("settings_window", "Local extensions path", None)
        )
        self.label_22.setText(
            QCoreApplication.translate("settings_window", "Extensions", None)
        )
        self.checkBox_auto_check_updates.setText(
            QCoreApplication.translate(
                "settings_window", "automatically search for updates", None
            )
        )
        self.label_23.setText(
            QCoreApplication.translate("settings_window", "Updates", None)
        )
        self.label_9.setText(
            QCoreApplication.translate("settings_window", "Logging", None)
        )
        self.label_17.setText(
            QCoreApplication.translate("settings_window", "old logfile backups", None)
        )
        self.label_16.setText(
            QCoreApplication.translate(
                "settings_window", "max. logfile size (MB)", None
            )
        )
        self.label_15.setText(
            QCoreApplication.translate("settings_window", "Log-Level", None)
        )
        self.radioButton_smart_backups.setText(
            QCoreApplication.translate("settings_window", '"smart" backups', None)
        )
        self.radioButton_all_backups.setText(
            QCoreApplication.translate("settings_window", "keep all backups", None)
        )
        self.radioButton_n_backups.setText(
            QCoreApplication.translate("settings_window", "keep only...", None)
        )
        self.checkBox_autosave_run.setText(
            QCoreApplication.translate("settings_window", "autosave before run", None)
        )
        self.checkBox_backup_before_run.setText(
            QCoreApplication.translate("settings_window", "backup before run", None)
        )
        self.label.setText(
            QCoreApplication.translate("settings_window", "Saving", None)
        )
        self.checkBox_autosave.setText(
            QCoreApplication.translate("settings_window", "autosave on closing", None)
        )
        self.checkBox_password.setText(
            QCoreApplication.translate("settings_window", "password protection", None)
        )
        self.checkBox_new_file_each_run.setText(
            QCoreApplication.translate(
                "settings_window", "save each measurement run in new file", None
            )
        )
        self.checkBox_play_camel_on_error.setText(
            QCoreApplication.translate(
                "settings_window", "Play Camel-Roar on error", None
            )
        )
        self.label_11.setText(
            QCoreApplication.translate("settings_window", "Sounds", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "settings_window", "Number-Formatting (only visual)", None
            )
        )
        self.radioButton_mixed.setText(
            QCoreApplication.translate("settings_window", "Scientific from 1e...", None)
        )
        self.radioButton_plain_numbers.setText(
            QCoreApplication.translate("settings_window", "Plain", None)
        )
        self.label_4.setText(
            QCoreApplication.translate("settings_window", "# decimals:", None)
        )
        self.radioButton_scientific.setText(
            QCoreApplication.translate("settings_window", "Scientific", None)
        )
        self.checkBox_dark.setText(
            QCoreApplication.translate("settings_window", "dark mode", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("settings_window", "Theme", None)
        )
