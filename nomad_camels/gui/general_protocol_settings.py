...
class Ui_Protocol_Settings(object):
    def setupUi(self, Protocol_Settings):
        ...
        self.pushButton_add_variable.setStyleSheet(
            "QPushButton {\n"
        ...
        self.pushButton_remove_variable.setStyleSheet(
            "QPushButton {\n"
    ...
    def retranslateUi(self, Protocol_Settings):
        Protocol_Settings.setWindowTitle(
            QCoreApplication.translate("Protocol_Settings", "Form", None)
        )
        self.checkBox_csv_exp.setText(
            QCoreApplication.translate("Protocol_Settings", "Export data to csv", None)
        )
        self.checkBox_json_exp.setText(
            QCoreApplication.translate(
                "Protocol_Settings", "Export metadata to json", None
            )
        )
        self.checkBox_no_config.setText(
            QCoreApplication.translate(
                "Protocol_Settings", "do not reconfigure instruments at start", None
            )
        )
        self.label.setText(
            QCoreApplication.translate("Protocol_Settings", "Filename:", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("Protocol_Settings", "Variables", None)
        )
        self.pushButton_add_variable.setText(
            QCoreApplication.translate("Protocol_Settings", "+", None)
        )
        self.label_title.setText(
            QCoreApplication.translate(
                "Protocol_Settings", "General Configuration", None
            )
        )
        self.label_4.setText(
            QCoreApplication.translate("Protocol_Settings", "Protocol Name:", None)
        )
        self.pushButton_remove_variable.setText(
            QCoreApplication.translate("Protocol_Settings", "-", None)
        )
        self.lineEdit_filename.setText(
            QCoreApplication.translate("Protocol_Settings", "Datafile", None)
        )
