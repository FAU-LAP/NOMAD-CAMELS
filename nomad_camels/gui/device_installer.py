...
"    }")
        ...
        self.gridLayout.addWidget(self.pushButton_license, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.textEdit_device_info, 1, 2, 5, 2)
        ...
        self.gridLayout.addWidget(self.progressBar, 0, 2, 1, 2)
