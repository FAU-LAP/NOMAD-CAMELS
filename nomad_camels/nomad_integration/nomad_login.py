...
from PySide6.QtWidgets import QApplication, QDialog, QLabel, QLineEdit, QGridLayout, QDialogButtonBox, QComboBox, QPushButton
...
class LoginDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        info_label = QLabel("We strongly recommend you to use NOMAD's app token for connecting.\nCopy the token from NOMAD (link below).")
