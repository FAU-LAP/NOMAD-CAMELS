...
class Ui_Plot_Options(object):
    def setupUi(self, Plot_Options):
        ...
        self.checkBox_log_y2.setObjectName(u"checkBox_log_y2")

        self.gridLayout.addWidget(self.checkBox_log_y2, 2, 0, 1, 1)

        self.checkBox_use_abs_x = QCheckBox(Plot_Options)
        self.checkBox_use_abs_x.setObjectName(u"checkBox_use_abs_x")
        ...
        self.checkBox_use_abs_y.setObjectName(u"checkBox_use_abs_y")
        ...
        self.checkBox_use_abs_y2.setObjectName(u"checkBox_use_abs_y2")
    ...
    def retranslateUi(self, Plot_Options):
        ...
        self.checkBox_log_x.setText(QCoreApplication.translate("Plot_Options", u"X-Axis logarithmic", None))
        self.checkBox_use_abs_y.setText(QCoreApplication.translate("Plot_Options", u"Use Absolute", None))
        self.checkBox_log_y.setText(QCoreApplication.translate("Plot_Options", u"Y-Axis logarithmic", None))
        self.checkBox_use_abs_y2.setText(QCoreApplication.translate("Plot_Options", u"Use Absolute", None))
    # retranslateUi
