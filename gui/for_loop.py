...
class Ui_for_loop_config(object):
    def setupUi(self, for_loop_config):
        ...
        for_loop_config.resize(630, 476)
        ...
        self.lineEdit_stop = QtWidgets.QLineEdit(self.sweep_widget)
        self.lineEdit_stop.setObjectName("lineEdit_stop")
        self.gridLayout_2.addWidget(self.lineEdit_stop, 4, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.sweep_widget)
        ...
        self.lineEdit_start = QtWidgets.QLineEdit(self.sweep_widget)
        ...
        self.lineEdit_min = QtWidgets.QLineEdit(self.sweep_widget)
        self.lineEdit_min.setObjectName("lineEdit_min")
        self.gridLayout_2.addWidget(self.lineEdit_min, 6, 0, 1, 1)
        self.lineEdit_n_points = QtWidgets.QLineEdit(self.sweep_widget)
    ...
    def retranslateUi(self, for_loop_config):
        ...
        self.label_5.setText(_translate("for_loop_config", "Max"))
        self.label_3.setText(_translate("for_loop_config", "Stop"))
        self.label_4.setText(_translate("for_loop_config", "Min"))
