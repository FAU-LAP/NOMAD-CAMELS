...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        self.gridLayout.addWidget(self.buttonBox, 19, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.label_9, 17, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.checkBox_autostart_ioc, 18, 1, 1, 3)
