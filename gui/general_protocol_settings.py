...
class Ui_Protocol_Settings(object):
    def setupUi(self, Protocol_Settings):
        ...
        self.gridLayout.addWidget(self.pushButton_remove_variable, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_add_variable, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableView_variables, 4, 0, 1, 4)
