...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_additionalUserInfo = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_additionalUserInfo.setObjectName("pushButton_additionalUserInfo")
        self.gridLayout_5.addWidget(self.pushButton_additionalUserInfo, 0, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_user, 0, 1, 1, 1)
        self.lineEdit_sample = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_sample.setObjectName("lineEdit_sample")
        self.gridLayout_5.addWidget(self.lineEdit_sample, 0, 4, 1, 1)
        self.pushButton_additionalSampleInfo = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_additionalSampleInfo.setObjectName("pushButton_additionalSampleInfo")
        self.gridLayout_5.addWidget(self.pushButton_additionalSampleInfo, 0, 5, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.dev_meas_splitter, 1, 0, 1, 6)
        ...
        self.actionSave_Measurement_Preset_As = QtWidgets.QAction(MainWindow)
        self.actionSave_Measurement_Preset_As.setObjectName("actionSave_Measurement_Preset_As")
        self.actionNew_Measurement_Preset = QtWidgets.QAction(MainWindow)
        self.actionNew_Measurement_Preset.setObjectName("actionNew_Measurement_Preset")
        ...
        self.menuFile.addAction(self.actionNew_Device_Preset)
        self.menuFile.addAction(self.actionSave_Device_Preset)
        self.menuFile.addAction(self.actionSave_Device_Preset_As)
        self.menuFile.addAction(self.actionOpen_Backup_Device_Preset)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionNew_Measurement_Preset)
        self.menuFile.addAction(self.actionSave_Measurement_Preset)
        self.menuFile.addAction(self.actionSave_Measurement_Preset_As)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_additionalUserInfo.setText(_translate("MainWindow", "Additional User-Information"))
        self.label_8.setText(_translate("MainWindow", "Sample"))
        self.label_7.setText(_translate("MainWindow", "User"))
        self.pushButton_additionalSampleInfo.setText(_translate("MainWindow", "Additional Sample-Information"))
        ...
        self.actionSave_Measurement_Preset_As.setText(_translate("MainWindow", "Save Measurement Preset As"))
        self.actionNew_Measurement_Preset.setText(_translate("MainWindow", "New Measurement Preset"))
